...
LEGACY: 
The iSolver series achieved approximately 15,000+ downloads globally. Because I no longer maintain the application, I have uploaded the code to a public repository in the hopes that someone may benefit from it. Of particular interest may be the objects supporting the graphing utility. While the solvers rely on simple regular expressions for parsing, the graphing calculator utilizes DParser code based on the Tomita algorithm. 
